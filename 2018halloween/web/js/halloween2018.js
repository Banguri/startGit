$(document).ready(function() {
	...
	var $body = $('body,html'),
			...
			$moveTop = $('.moveTop');
	// Go top
	$moveTop.hover(function(){
		TweenMax.to($moveTop, 0, {opacity:0.5})
		TweenMax.to($moveTop, 1, {opacity:1, ease:RoughEase.ease, repeat:-1, repeatDelay:0.6, yoyo:true});
	}, function() {
		TweenMax.to($moveTop, 0, {opacity:1});
	});
	// Smooth scrolling
	...
	$(window).scroll(function() {
		...
		if(scrollbarLocation > 0){
			...
			TweenMax.to($moveTop, 0.5, {opacity:1, ease:Bounce.easeOut});
		} else {
			$header.removeClass('fixed');
			TweenMax.to($moveTop, 0.5, {opacity:0, ease:Bounce.easeOut});
		};
	});
	//////// screen fade in
	...
	var $introTitleWrap = $('.introTitleWrap'),
			...
			$introPoliceLine = $('.introPoliceLine'),
	...
	function fadePage() {
		...
		TweenMax.to($introPoliceLine, 1, {opacity:1, ease:Elastic.easeOut});
	}
	function introTitle() {
	...
	function introDoorOpen() {
		...
		TweenMax.to($introBg, 0, {delay:0, scale:0.5, opacity:0.5});
		TweenMax.to($introBg, 1.6, {delay:0.5, scale:4, opacity:1, ease:Bounce.easeIn});
	}
	...
	var tween = new TimelineMax({repeat: -1, repeatDelay: 1.2, yoyo: true})
							.to($('.mainTitleWrap .titleI'), 0, {opacity: 1})
							.to($('.mainTitleWrap .titleI'), 0.8, {opacity: 0, ease: RoughEase.ease})
							.to($('.mainTitleWrap .titleI'), 0.2, {opacity: 1, ease: RoughEase.ease});
	var scene = new ScrollMagic
							.Scene({triggerElement: "#main", duration: 1100, offset: 0})
							.setTween(tween)
							//.addIndicators({name: "loop"})
	...
	var scene = new ScrollMagic
							...
							.addTo(controller);
	// Zombie (back left)
	var tween = new TimelineMax({repeat: -1, repeatDelay: 0.6, yoyo: true})
							.to($('.mainZombieLeft'), 0.6, {marginBottom: 6, ease: RoughEase.ease})
							.to($('.mainZombieLeft'), 0.6, {marginBottom: 0, ease: RoughEase.ease});
	var scene = new ScrollMagic
							.Scene({triggerElement: "#main", duration: 1100, offset: 0})
							.setTween(tween)
							//.addIndicators({name: "loop"})
							.addTo(controller);
	// Zombie (back right)
	var tween = new TimelineMax({repeat: -1, repeatDelay: 0.9, yoyo: true})
							.to($('.mainZombieRight'), 1, {marginBottom: 4, ease: RoughEase.ease})
							.to($('.mainZombieRight'), 1, {marginBottom: 0, ease: RoughEase.ease});
	var scene = new ScrollMagic
							.Scene({triggerElement: "#main", duration: 1100, offset: 0})
							.setTween(tween)
							//.addIndicators({name: "loop"})
	...
	var tween = new TimelineMax({repeat: -1, repeatDelay: 0, yoyo: true})
							.to($('.mainZombieCenter2'), 0, {marginLeft: -105, ease: RoughEase.ease})
							.to($('.mainZombieCenter2'), 0.4, {marginLeft: -100, ease: RoughEase.ease})
							.to($('.mainZombieCenter2'), 0.5, {marginLeft: -105, ease: RoughEase.ease})
							.to($('.mainZombieCenter2'), 0.7, {marginLeft: -110, ease: RoughEase.ease})
							.to($('.mainZombieCenter2'), 0.2, {marginLeft: -105, ease: RoughEase.ease});
	var scene = new ScrollMagic
							.Scene({triggerElement: "#main", duration: 1100, offset: 0})
							.setTween(tween)
							//.addIndicators({name: "loop"})
	...
	var tween = new TimelineMax({repeat: -1, repeatDelay: 0.2, yoyo: true})
							.to($('.mainZombieCenter1'), 0, {marginLeft: 202, ease: RoughEase.ease})
							.to($('.mainZombieCenter1'), 0.5, {marginLeft: 212, ease: RoughEase.ease})
							.to($('.mainZombieCenter1'), 0.6, {marginLeft: 202, ease: RoughEase.ease})
							.to($('.mainZombieCenter1'), 0.9, {marginLeft: 192, ease: RoughEase.ease})
							.to($('.mainZombieCenter1'), 0.3, {marginLeft: 202, ease: RoughEase.ease});
	var scene = new ScrollMagic
							.Scene({triggerElement: "#main", duration: 1100, offset: 0})
							.setTween(tween)
							//.addIndicators({name: "loop"})
	...
	function scrollTween() {
		TweenMax.set(".scrollTween", {opacity: 0});
	...
	////////  zombie action
	var $zombieAll = $('.mainZombieCenter1, .mainZombieCenter2');
	$zombieAll.each(function() {
		$(this).delegate('', 'mouseenter focusin mouseleave focusout', function (event) {
			switch (event.type) {
				// over
				case 'mouseenter' :
				case 'focusin' :
					TweenMax.to($(this), 0, {scale:1});
					TweenMax.to($(this), 0.3, {scale:1.7, ease:Power4.easeIn, repeat: 1, yoyo:true});
				break;
				// out
				case 'mouseleave' :
				case 'focusout' :
